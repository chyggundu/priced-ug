...
function BrowsePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$10_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrowsePage.useEffect": ()=>{
            const id = setTimeout({
                "BrowsePage.useEffect.id": ()=>setQuery(search.trim())
            }["BrowsePage.useEffect.id"], 300);
            return ({
                "BrowsePage.useEffect": ()=>clearTimeout(id)
            })["BrowsePage.useEffect"];
        }
    }["BrowsePage.useEffect"], [
        search
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$10_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrowsePage.useEffect": ()=>{
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSupabaseConfigured"]) {
                setError("Supabase is not configured for this build.");
                setLoading(false);
                return;
            }
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategories"])().then(setCategories).catch({
                "BrowsePage.useEffect": ()=>setCategories([])
            }["BrowsePage.useEffect"]);
        }
    }["BrowsePage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$10_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrowsePage.useEffect": ()=>{
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSupabaseConfigured"]) return;
            let active = true;
            setLoading(true);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["searchProducts"])({
                q: query || undefined,
                categoryId
            }).then({
                "BrowsePage.useEffect": (rows)=>active && setProducts(rows)
            }["BrowsePage.useEffect"]).catch({
                "BrowsePage.useEffect": (e)=>active && setError(e instanceof Error ? e.message : "Could not load items.")
            }["BrowsePage.useEffect"]).finally({
                "BrowsePage.useEffect": ()=>active && setLoading(false)
            }["BrowsePage.useEffect"]);
            return ({
                "BrowsePage.useEffect": ()=>{
                    active = false;
    ...
    const sorted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$2$2e$10_react$2d$dom$40$19$2e$2$2e$7_react$40$19$2e$2$2e$7_$5f$react$40$19$2e$2$2e$7$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BrowsePage.useMemo[sorted]": ()=>{
            const list = [
                ...products
            ];
            if (sortBy === "newest") return list;
            return list.sort({
                "BrowsePage.useMemo[sorted]": (a, b)=>{
...
_s(BrowsePage, "1Q+MhOM7QNQkfdjYv3phPTKtLSA=");
_c = BrowsePage;
...
//# sourceMappingURL=_0puypnk._.js.map