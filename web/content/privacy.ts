/**
 * The Priced Ug privacy policy, mirrored from the generated policy that the app
 * currently links to:
 * https://www.privacypolicies.com/live/946d3c97-3ea2-45a7-8fa8-f6573aa0a411
 *
 * Once this site is live, point the app's privacy link at `<site>/privacy`
 * instead — that is the whole reason this page exists.
 *
 * Keep the wording in sync with the source policy. If the policy is regenerated,
...
export const privacySections: Section[] = [
    ...
    blocks: [
      { type: "p", text: "For the purposes of this Privacy Policy:" },
      {
        ...
        items: [
          ...
          {
            lead: "Application",
            text: "refers to pricedug, the software program provided by the Company.",
          },
          {
            lead: "Company",
            text: "(referred to as either “the Company”, “We”, “Us” or “Our” in this Privacy Policy) refers to pricedug.",
          },
          { lead: "Country", text: "refers to: California, United States" },
          {
            lead: "Device",
          ...
          {
            lead: "Personal Data",
            text: "(or “Personal Information”) is any information that relates to an identified or identifiable individual. We use “Personal Data” and “Personal Information” interchangeably unless a law uses a specific term.",
          },
          { lead: "Service", text: "refers to the Application." },
          {
  ...
  { heading: "Collecting and Using Your Personal Data", level: 2, blocks: [] },
  { heading: "Types of Data Collected", level: 3, blocks: [] },
  {
    ...
    blocks: [
      { type: "p", text: "The Company may use Personal Data for the following purposes:" },
      {
        ...
        items: [
          ...
          {
            lead: "For the performance of a contract:",
          ...
          { lead: "To manage Your requests:", text: "To attend and manage Your requests to Us." },
          {
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Where possible, We apply shorter retention periods and/or reduce identifiability by deleting, aggregating, or anonymizing data. Unless otherwise stated, the retention periods below are maximum periods (“up to”) and We may delete or anonymize data sooner when it is no longer needed for the relevant purpose. We apply different retention periods to different categories of Personal Data based on the purpose of processing and legal obligations:",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          {
            lead: "User Accounts:",
            text: "retained for the duration of your account relationship plus up to 24 months after account closure to handle any post-termination issues or resolve disputes.",
          },
        ],
      },
    ],
    ...
    blocks: [
      {
        ...
        items: [
          {
            lead: "Support tickets and correspondence:",
            text: "up to 24 months from the date of ticket closure to resolve follow-up inquiries, track service quality, and defend against potential legal claims",
          },
          {
            lead: "Chat transcripts:",
            text: "up to 24 months for quality assurance and staff training purposes.",
          },
        ],
      },
    ],
  ...
  {
    // The source policy uses the "Usage Data" heading twice — once under Types of
    // Data Collected and again here under Retention. Kept verbatim rather than
    // disambiguated, because this mirrors a legal document.
    heading: "Usage Data",
    level: 3,
    blocks: [
      {
        ...
        items: [
          {
            lead: "Application usage statistics:",
            text: "up to 24 months to understand feature adoption and service improvements.",
          },
          {
            lead: "Server logs (IP addresses, access times):",
            text: "up to 24 months for security monitoring and troubleshooting purposes.",
          },
        ],
      },
      {
        type: "p",
        text: "Usage Data is retained in accordance with the retention periods described above, and may be retained longer only where necessary for security, fraud prevention, or legal compliance.",
      },
      {
        type: "p",
        text: "We may retain Personal Data beyond the periods stated above for different reasons:",
      },
      {
        type: "list",
        items: [
          {
            ...
            text: "We are required by law to retain specific data (e.g., financial records for tax authorities).",
          },
          {
            lead: "Legal claims:",
            text: "Data is necessary to establish, exercise, or defend legal claims.",
          },
          { lead: "Your explicit request:", text: "You ask Us to retain specific information." },
          {
            lead: "Technical limitations:",
            text: "Data exists in backup systems that are scheduled for routine deletion.",
          },
        ],
      },
      {
        type: "p",
        text: "You may request information about how long We will retain Your Personal Data by contacting Us.",
      },
      {
        type: "p",
        text: "When retention periods expire, We securely delete or anonymize Personal Data according to the following procedures:",
      },
      {
        type: "list",
        items: [
  ...
  { heading: "Disclosure of Your Personal Data", level: 2, blocks: [] },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "Our Service does not address anyone under the age of 16. We do not knowingly collect personally identifiable information from anyone under the age of 16. If You are a parent or guardian and You are aware that Your child has provided Us with Personal Data, please contact Us. If We become aware that We have collected Personal Data from anyone under the age of 16 without verification of parental consent, We take steps to remove that information from Our servers.",
      },
      {
        type: "p",
